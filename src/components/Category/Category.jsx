      ...
      <div className="flex w-2/3">
        {products.map((product) => (
          <div key={product.id} className="flex flex-col items-center bg-orange-300 p-4 w-1/3 translate-y-0 scale-105 group hover:scale-100">
            <h3 className="text-xl font-bold mb-2 flex">{product.title} <AiOutlineArrowRight className="ml-2 w-4 h-4  my-[7px] [transform transition-transform duration-300 group-hover:translate-x-1" />   </h3>  
